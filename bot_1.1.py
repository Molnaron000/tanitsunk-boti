...
# Biztonsági okokból fontos, hogy ne írd be közvetlenül ide a kulcsot!
...
bucket_name = "tanitsunk-boti-docs-2025"  # <-- cseréld ki a saját bucket nevedre!
pdf_file = "teszt.pdf"
...
st.write("---")
st.info("Ez egy kezdeti bot a 'Neumann János Egyetem Tanítsunk Magyarországért' programhoz. A válaszok most már a Gemini AI-tól származhatnak, de hamarosan dokumentumokat is fogok tudni olvasni!")
